...
class Mesa(Base):
    ...
    pareja_partida1_id = Column(Integer, ForeignKey("pareja_partida.id"), nullable=False)
    pareja_partida2_id = Column(Integer, ForeignKey("pareja_partida.id"), nullable=True)  # Nullable para la última mesa
